...
local Library = Update:Window("NAME ","",Enum.KeyCode.RightControl);
Main = Library:Tab("General")
Stats = Library:Tab("Auto Stats + Setting")
...
Main:Toggle("fastAttack",true,function(value)
    _G.FastAttack = value
end)
...
Main:Toggle("super fast attack(ระวังโดนเตะ)",false,function()
...
Stats:Toggle("up stats test",true,function()
    while true do
